...
public class Pure_FPP_Controller : MonoBehaviour {
	...
	void UpdateScore()
	{
		...
		{
			slider.value = ScoreRedCrystal;
			RedCountdown.text = ("" + ScoreRedCrystal);

			if (Score >= 10 && ScoreRedCrystal >= 10)
			{
	...
	{
		Healthslider.value = HealthScore;
	...
	public void HeailingPlayer(int value)
	{
		HealthScore = HealthScore + value;
	...
	public void RedCrystalScore(int value)
	{
		ScoreRedCrystal = ScoreRedCrystal + value;
