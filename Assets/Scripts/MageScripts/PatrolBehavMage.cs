...
public class PatrolBehavMage : StateMachineBehaviour
{
    private ParolSpotsMage patrol;
    public float speed;
    ...
    {
        patrol = GameObject.FindGameObjectWithTag("ParolSpotsMage").GetComponent<ParolSpotsMage>();
